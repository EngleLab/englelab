...
## Calculate Flanker scores based on trimming long RT trials and removing low performers
data_flanker <- data_import %>%
...
data_flanker <- remove.save(data_flanker, remove = data_remove, 
                            save = here(output.dir, "remove"), taskname = "Flanker")
