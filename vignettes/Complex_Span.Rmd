...
-   **EditDistance.unit**: Trial-level scores needed to calculate complex-span scoers based on the edit distance unit scoring method

-   **EditDistance.load**: Trial-level scores needed to calculate complex-span scoers based on the edit distance unit scoring method
...
-   **[Task].EditDistanceScore**: Edit Distance scoring method (*sum of EditDistance.load*)

    *i.e. SymSpan.EditDistanceScore or RotSpan.EditDistanceScore*

-   **[Task].EditDistanceUnit**: Edit Distance unit score (*mean of EditDistance.unit*)

-   **[Task].EditDistanceLoad**: Edit Distance load score (*sum of EditDistance.load divided by Total number of memory items*)
